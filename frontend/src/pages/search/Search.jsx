...
const Search = () => {
    ...
    const handleSearch = () => {
        ...
        if (query.length === 0) setFilteredProducts(productsData);
    }
    return (
        <>
            ...
            <section className='section__container'>
                <div className='w-full mb-12 flex flex-col md:flex-row items-center justify-center gap-4'>
                    <input type='text' value={searchQuery} placeholder='Search for products...'
                        onChange={(e) => setSearchQuery(e.target.value)} className='search-bar w-full max-w-4xl p-2 border rounded'
                    />
